        ...
        <hr>
         <div class="product-post-header">
            ...
            <div class="product-post-user">
                ...
                <a href="{{ route('user.account',$take->product->user->username) }}" class="product-post-username">{{ '@' . $take->product->user->username }} <i class="bi bi-dot"></i> {{ $take->created_at->diffForHumans() }}</a>
            </div>
